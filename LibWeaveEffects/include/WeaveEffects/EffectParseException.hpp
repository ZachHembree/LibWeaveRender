...
#define FX_ASSERT(COND) WV_IF_NOT(COND, FX_THROW("Assert failed") )
#define FX_ASSERT_MSG(COND, ...) WV_IF_NOT(COND, FX_THROW(__VA_ARGS__) )

#define FXSYNTAX_ASSERT(COND) WV_IF_NOT(COND, FXSYNTAX_THROW("Assert failed") )
#define FXSYNTAX_ASSERT_MSG(COND, ...) WV_IF_NOT(COND, FXSYNTAX_THROW(__VA_ARGS__) )

#define FXBLOCK_ASSERT(COND,CTX, BLOCK) WV_IF_NOT(COND, FXBLOCK_THROW(CTX, BLOCK, "Assert failed") )
#define FXBLOCK_ASSERT_MSG(COND, CTX, BLOCK, ...) WV_IF_NOT(COND, FXBLOCK_THROW(CTX, BLOCK, __VA_ARGS__) )
...
#define FX_ASSERT(COND) WV_EMPTY(COND)
#define FX_ASSERT_MSG(COND, ...) WV_EMPTY(COND)

#define FXSYNTAX_ASSERT(COND) WV_EMPTY(COND)
#define FXSYNTAX_ASSERT_MSG(COND, ...) WV_EMPTY(COND)

#define FXBLOCK_ASSERT(COND,CTX, BLOCK) WV_EMPTY(COND)
#define FXBLOCK_ASSERT_MSG(COND, CTX, BLOCK, ...) WV_EMPTY(COND)

#endif

#define FX_CHECK(COND) WV_IF_NOT(COND, FX_THROW("Check failed") )
#define FX_CHECK_MSG(COND, ...) WV_IF_NOT(COND, FX_THROW(__VA_ARGS__) )

#define FXSYNTAX_CHECK(COND) WV_IF_NOT(COND, FXSYNTAX_THROW("Check failed") )
#define FXSYNTAX_CHECK_MSG(COND, ...) WV_IF_NOT(COND, FXSYNTAX_THROW(__VA_ARGS__) )

#define FXBLOCK_CHECK(COND,CTX, BLOCK) WV_IF_NOT(COND, FXBLOCK_THROW(CTX, BLOCK, "Check failed") )
#define FXBLOCK_CHECK_MSG(COND, CTX, BLOCK, ...) WV_IF_NOT(COND, FXBLOCK_THROW(CTX, BLOCK, __VA_ARGS__) )
...
namespace Weave::Effects
{
	...
	/// </summary>
	class EffectParseException : public WeaveException
	{
	public:
